    ...
    <div class="content">
        ...
        <div class="section-content">
            <div class="d-flex justify-content-start">
                <img id="img-section" src="https://portalunimar.unimar.edu.ve/./image/views/es/newstudents/newstudents-09.png"><h4>Tesis de Grado por Autor</h4>
            </div>
        </div>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-top clearfix" style="margin-top:2rem; margin-bottom: 2rem;">
                                <h4 style="float: left;">Tesis de Grado por Autor <a href=""><i class="fa fa-list"></i></a></h4>
                            </div>
                        ...
                        <div class="blog-box row my-2">
                            <div class="blog-meta big-meta col-md-12 text-left pb-5">
                                <h4><a href="/projects/autor/{{ $autor->id }}" title="">{{ $autor->lastname }}, {{ $autor->name }} ({{$autor->aprojects}})</a></h4>
                            </div>
                        </div>
                        @endforeach
                    </div>
