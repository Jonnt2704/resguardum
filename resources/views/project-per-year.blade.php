    ...
    <div class="content">
        ...
        <div class="justify-content-around row">
           ...
           <div class="col-sm-4 col-md-3 my-2 text-center" aria-expanded="false" >
                <a id="campusbtn" href="/mainYears/{{ $projectYear->year }}">
                    <img src="https://portalunimar.unimar.edu.ve/./image/views/es/officialpubs/cont-07.png" width="80%">
                    <p class="fs-6 font-weight-bold text-center" id="name-funders">{{ $projectYear->year }} - ({{ $projectYear->pAmount }})</p>
