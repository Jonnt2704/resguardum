...
<html lang="es">
    ...
    <marquee style="background-color: #d0e0fc; color:#0b3d91;">
        <i class="fa fa-info-circle" aria-hidden="true"></i>
         El valor del dólar, según el BCV, para el día de hoy <span>11-02-2024 es </span><strong id="dollar-bcv-price"></strong>&nbsp;Bs
    </marquee>
    <!-- /.dollar-price -->
    ...
    <!-- /.navigation-bar -->
        ...
        <div class="banner-main">
            <img src="https://portalunimar.unimar.edu.ve/./image/banners/es/academic-offers/academic-offers.jpg" width="100%">
        </div>
        <!-- /.main-banner -->
        ...
        <div class="section-content">
            <div class="d-flex justify-content-start">
                <img id="img-section" src="https://portalunimar.unimar.edu.ve/./image/views/es/academic-offers/OfAc-02.png"><h4>Ofertas Académicas</h4>
            </div>
