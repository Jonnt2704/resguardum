                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <?php if($tipo == 'tutor') { ?>
                            <h4 style="float: left;">Proyectos de @php echo $tipo; @endphp Academico: {{$types[0]->lastname}}, {{$types[0]->name}} <a href=""><i class="fa fa-list"></i></a></h4>
                            <?php } else { ?> 
                            <h4 style="float: left;">Proyectos de @php echo $tipo; @endphp: {{$types[0]->lastname}}, {{$types[0]->name}} <a href=""><i class="fa fa-list"></i></a></h4>
                            <?php } ?>
                            </div>
                        ...
                        <div class="blog-box row my-2">
                            ...
                            <div class="blog-meta big-meta col-md-8 text-left pb-5">
                                <h6><a href="/single/project/{{ $project->id }}" title="">{{ $project->title }}</a></h6>
