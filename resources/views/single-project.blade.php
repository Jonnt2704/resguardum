...
<html lang="es">
    <head>
        ...
        <!-- CSRF Token -->
        <meta name="csrf-token" content="uXGPth7Ejm0G47JoYxtZSKlBAioODUHiSBUcJ1KE">
        <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-sm-8 col-12 header-media">
                ...
                <div class="float-right header-media-float  mx-2">
                    <a href="https://portalunimar.unimar.edu.ve/service/onlinepayment/inicio" target="_self" title="pagos-online">
                        <img src="https://portalunimar.unimar.edu.ve/./image/bank-onlineb.png" style="width:25px;">
                    </a>
                </div>
            </div>
...
>>>>>>> ce1107b17ac5d14b0768d5e33b44443823d01e4a
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-light bg-white">
            <!-- Unimar Logo -->
            <a class="navbar-brand text-dark" href="https://portalunimar.unimar.edu.ve/home" ><img class="logo horizontal-logo" src="https://portalunimar.unimar.edu.ve/image/logounimar-22.jpg" alt="UNIMAR logo" width="100%"></a>
            <!-- Mobile Menu -->
                ...
                <div class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item px-1 dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                            ...
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/university-gazzette">Publicaciones Oficiales</a>
                        </div>
                    </li>
                    <!-- General Secretary -->
                    <li class="nav-item px-1 dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/general-secretary-department">Nuestro Subsistema</a>
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/study-control">Control de Estudios</a>
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/student-welfare">Bienestar Estudiantil</a>
                        </div>
                    </li>
                    <!-- Academic -->
                    <li class="nav-item px-1 dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/academic-vicerectorate">Vicerrectorado</a>
                    ...
                    <li class="nav-item px-1 dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/extension-vicerectorate">Vicerrectorado</a>
                            <a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/community-service">Servicio Comunitario</a>
                        </div>
                    </li>
                    <!-- Students -->
                    <li class="nav-item px-1 dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
                            <div class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Pregrado</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/new-students">Nuevos Ingresos</a></li>
                                    <li><a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/regular-students">Estudiantes Regulares</a></li>
                                    <li><a class="dropdown-item" href="https://portalunimar.unimar.edu.ve/alumni">Egresados</a></li>
                                </ul>
                            </div>
                            <div class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Postgrado</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="postgraduate/new-students">Nuevos Ingresos</a></li>
                                </ul>
                            </div>
                            <div class="dropdown-submenu"><a class="dropdown-item dropdown-toggle" href="#">Extensión</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Cursos y Talleres</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
    ...
    <div class="content">
        ...
        <div class="section-content">
            <div class="d-flex justify-content-start">
                <img id="img-section" src="https://portalunimar.unimar.edu.ve/./image/views/es/newstudents/newstudents-09.png"><h4>Tesis de Grado</h4>
            </div>
        </div>
        <!-- /.section-id -->
        @php

        $fecha = strtotime($projectData[0]->create_date);
        $year = strftime("%Y", $fecha);

        $path = substr($projectData[0]->path, 10);
...
>>>>>>> ce1107b17ac5d14b0768d5e33b44443823d01e4a
                                ...
                                <div class="col-md-12 my-2 px-4" style="padding: 0;">
                                <div class="row no-gutters bg-greey" style="height:100%;">
                                    <div class="col-md-4 text-white content-date" style="border-radius:0px;">
                                        <p><img src="{{asset('assets/img/pdf.png')}}" alt="tesis-unimar"></p>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body" id="card-content">
                                            <a href="{{ route('download', ['filename' => $path]) }}" class="btn btn-sm btn-primary">Descargar</a>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="col-md-8">
                                <div class="card-body text-left">
                                    <p class="card-text fs-6 font-weight-bold">Titulo</p>
                                    <h3 class="card-title fs-6 mb-4 mt-1">{{ $projectData[0]->title}}</h3>
                                    <p class="card-text fs-6 font-weight-bold">Autor</p>
                                    <h3 class="card-title fs-6 mb-1 mt-1">{{ $projectData[0]->Aname}} {{ $projectData[0]->Alastname}}</h3>
                                    <p class="card-text font-weight-bold" id="name-funders">estudiante.1234@unimar.edu.ve</p>
                                    <p class="card-text fs-6 font-weight-bold">Tutor</p>
                                    <h3 class="card-title fs-6 mb-4 mt-1">{{ $projectData[0]->tname}} {{ $projectData[0]->tlastname}}</h3>
                                    <p class="card-text fs-6 font-weight-bold">Tema </p>
                                    <h3 class="card-title fs-6 mb-4 mt-1 lh-base">{{ $projectData[0]->lineName}}</h3>
                                    <p class="card-text fs-6 font-weight-bold">Resumen: </p>
                                    <h3 class="card-title fs-6 mb-4 mt-1 lh-base">{{ $projectData[0]->resume}}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="footer col-sm-12" id="footerdesktop">
    ...
    <div class="copyright-content">
        <span>© Copyright 2001-2024 Universidad de Margarita, Rif: J-30660040-0. Isla de Margarita - Venezuela.</span>
    </div>
</div>
<!-- /.desktop-footer -->
                    ...
                    <ul>
                        ...
                        <li class="footer-item">
                            <a class="footer-title"
                                href="https://portalunimar.unimar.edu.ve/vicerectorates">Vicerrectorados</a>
                        </li>
                        <li class="footer-item">
                            <a class="footer-title" href="https://portalunimar.unimar.edu.ve/deaneries">Decanatos</a>
                        </li>
                        <li class="footer-item">
                            <a class="footer-title"
                                href="https://portalunimar.unimar.edu.ve/student-welfare">Bienestar Estudiantil</a>
                        </li>
                    </ul>
                </div>
            </div>
