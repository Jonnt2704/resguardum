    ...
    <!-- /.navigation-bar -->
        ...
        <div class="section-content">
            <div class="d-flex justify-content-start">
                ...
                <h4>Herramienta de Inteligencia Artificial</h4>
            </div>
            <div class="card border-0 card-body sectionbody">
                <p class="text-justify"> Usa la tecnologia de la IA (Inteligencia Artificial) para generar una posible propuesta de titulo para tu futura Tesis de grado. Describe tu proyecto para que la IA pueda facilitarte los posibles titulos</p>
            </div>
        </div>
        ...
        <script type="module">
            ...
            document.getElementById('generateBtn').addEventListener('click', async () => {
                ...
                try {
                    ...
                    document.getElementById('query_answers').innerText = response.text();
